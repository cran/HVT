...
## HVT (v25.2.1) | What's New? {-}

27th January, 2025

In this version of the HVT package, the following new function and vignette have been introduced:

**Function**

1. **Dynamic Forecasting of a Time Series Dataset**: This update introduces a new function for dynamic forecasting of states using time series dataset, called Monte Carlo Simulations of Markov Chain - `msm`. It supports both ex-post and ex-ante forecasting, offering valuable insights into future trends while resolving state transition challenges through clustering and nearest-neighbor methods to enhance simulation accuracy.
